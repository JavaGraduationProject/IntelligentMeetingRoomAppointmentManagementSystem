						...
						<div class="table-responsive">
							<table class="table  table-striped table-bordered  table-hover">
								...
								<tbody id="detailBody">
									...
									<tr>
										<th width="10%">邮箱</th>
										<th width="90%"  >${detail.userMsg.email}</th>
									</tr>
									<tr>
										<th width="10%">性别</th>
									...
									<tr>
										<th width="10%">用户类型</th>
										<th width="90%"  >${detail.userTypeStr}</th>
									</tr>
									<tr>
										<th width="10%">所属部门</th>
										<th width="90%"class="thContentStyle"  id=departIdStr>${detail.departIdStr}</th>
									</tr>
									<tr>
										<th width="10%">职位名</th>
										<th width="90%"  >${detail.userMsg.jobName}</th>
									</tr>
									<tr>
										<th width="10%">创建时间</th>
