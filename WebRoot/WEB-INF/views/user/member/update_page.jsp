...
<title>修改-参会人员</title>
<meta name="keywords" content="修改-参会人员">
<meta name="description" content="修改-参会人员">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=9528"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/user/member/update_submit',
		data:{
			"id":'${data.id}',
