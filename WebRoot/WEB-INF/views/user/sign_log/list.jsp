...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=9377"></script>
...
function ajaxList(page) {
	...
	$.ajax({
		type : 'get',
		url : "${pageContext.request.contextPath}/user/sign_log/queryList",
		data : {
...
function ajaxCount() {
	...
	$.ajax({
		type : 'get',
		url : "${pageContext.request.contextPath}/user/sign_log/queryCount",
		async: false,
		data : {
			"meetingId":"${data.meetingId}",
			"signTime1":signTime1,
