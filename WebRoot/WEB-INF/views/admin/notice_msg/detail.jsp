...
<title>公告-详情页</title>
<meta name="keywords" content="公告-详情页">
<meta name="description" content="公告-详情页">
				...
				<div class="ibox-content">
					<div style="width:80%;margin-left:10%">
						<div class="row"  style="margin-top:5px;padding-left: 15px;">
							<a href="javascript:void(0)"  onclick="javascript:history.back(-1);" class="btn btn-success">返回</a>
						</div>
						<div class="table-responsive">
							<table class="table  table-striped table-bordered  table-hover">
								...
								<tbody id="detailBody">
									<tr>
										<th width="10%">标题</th>
										<th width="70%"class="thContentStyle" >${detail.noticeMsg.noticeName}</th>
									</tr>
									<tr>
										<th width="10%">公告详情</th>
										<th width="70%"class="thContentStyle" ><div style="width:70%;">${detail.noticeMsg.noticeDetail}</div></th>
									</tr>
									<tr>
										<th width="10%">创建时间</th>
										<th width="70%"class="thContentStyle" >${detail.noticeMsg.createTime}</th>
									</tr>
								</tbody>
							</table>
						</div>
