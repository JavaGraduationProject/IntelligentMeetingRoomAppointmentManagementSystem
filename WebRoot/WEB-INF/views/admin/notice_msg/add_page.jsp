...
<title>新增-公告</title>
<meta name="keywords" content="新增-公告">
<meta name="description" content="新增-公告">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="noticeNameParentContent">
								...
								<input type="text" value="" placeholder="请输入标题" id="noticeName" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=5651"></script>
...
function getEditVal(name){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/notice_msg/add_submit',
		data:{
