...
<title>新增-共享文件</title>
<meta name="keywords" content="新增-共享文件">
<meta name="description" content="新增-共享文件">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="titleParentContent">
								...
								<input type="text" value="" placeholder="请输入标题" id="title" class="form-control">
							</div>
							<div class="form-group" id="fintroParentContent">
								<label>文件介绍<span style="color:red">(*必填)</span></label>
								<textarea class="form-control"  placeholder="请输入文件介绍"  id="fintro"  rows="4" ></textarea>
							</div>
							<div class="form-group" id="fileUrlParentContent">
								<label>文件链接<span style="color:red">(*必填)</span></label>
								<div id="fileUrl" class="dropzone" data-id="fileUrl" max-num="1" file-type="4" max-size="1000" init-val=""></div>
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=7451"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/file_share/add_submit',
		data:{
			"title":title,
			"fintro":fintro,
			"fileUrl":fileUrl
