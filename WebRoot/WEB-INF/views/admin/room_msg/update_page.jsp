...
<title>修改-会议室</title>
<meta name="keywords" content="修改-会议室">
<meta name="description" content="修改-会议室">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="roomNoParentContent">
								...
								<input type="text" value="${data.roomNo}" placeholder="请输入会议室编号" id="roomNo" class="form-control">
							</div>
							<div class="form-group" id="roomTypeParentContent">
								...
								<select id="roomType"  class="form-control">
									<c:forEach items="${roomTypeList}" var="item">
										<c:if test="${item.id==data.roomType}">
							...
							<div class="form-group" id="raddressParentContent">
								...
								<input type="text" value="${data.raddress}" placeholder="请输入会议室地址" id="raddress" class="form-control">
							</div>
							<div class="form-group" id="rhyssbParentContent">
								<label>会议室设备<span style="color:red">(*必填)</span></label>
								<input type="text" value="${data.rhyssb}" placeholder="请输入会议室设备" id="rhyssb" class="form-control">
							</div>
							<div class="form-group" id="numParentContent">
								<label>容纳人数<span style="color:red">(*必填)</span></label>
								<input type="text" value="${data.num}" placeholder="请输入容纳人数(请输入数字)" id="num" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2598"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/room_msg/update_submit',
		data:{
			"id":'${data.id}',
			"roomNo":roomNo,
			"roomType":roomType,
