			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					...
					<div class="row"  style="margin-top:5px;padding-left: 15px;">
						<a href="${pageContext.request.contextPath}/admin/depart_msg/add" class="btn btn-primary">新增</a>
					</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=3322"></script>
...
function ajaxList(page) {
	...
	$.ajax({
		type : 'get',
		url : "${pageContext.request.contextPath}/admin/depart_msg/queryList",
		data : {
			"page":page,
			"dname":dname
		},
		success : function(result) {
			...
			for (var i = 0; i < rows.length; i++) {
				...
				html+='<td>'+ dnameVal+'</td>';
				html+='<td>';
				html+='<a href="${pageContext.request.contextPath}/admin/depart_msg/update?id='+rows[i].departMsg.id+'" class="btn btn-success btnStyle">修改</a>';
...
function ajaxCount() {
	...
	$.ajax({
		type : 'get',
		url : "${pageContext.request.contextPath}/admin/depart_msg/queryCount",
		async: false,
		data : {
			"dname":dname
		},
...
function del(e){
	if(window.confirm('你确定要删除该部门吗')){
		...
		$.ajax({
			type : 'get',
			url : "${pageContext.request.contextPath}/admin/depart_msg/del",
			data : {
				"id":id
			},
			success : function(result) {
